/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env=local` (hash: f247de83609a5769e86695469cd53a00)
...
interface __BaseEnv_Env {
	...
	BENCH_COORDINATOR: DurableObjectNamespace<import("./worker/index").BenchCoordinator>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "BenchCoordinator";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "AUTH_MODE" | "MUTATIONS_ENABLED" | "ACCESS_TEAM_DOMAIN" | "ACCESS_AUD" | "ALLOWED_ORIGIN" | "LOCAL_OPERATOR_TOKEN">> {}
}
